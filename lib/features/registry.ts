...
export const FEATURE_REGISTRY: FeatureEntry[] = [
  ...
  { id: "slack_communities", name: "Slack communities", status: "live", description: "Comunidades públicas" },
  { id: "google_alerts", name: "Google Alerts", status: "live", description: "Forward email → señales" },
  { id: "rss_blogs", name: "RSS / blogs", status: "live", description: "Dev.to, Medium" },
  { id: "github_issues", name: "GitHub Issues", status: "live", description: "Alternatives to X" },
  { id: "app_store", name: "App Store reviews", status: "live", description: "Quejas competidores" },
  ...
  { id: "weekly_pdf", name: "Standup export PDF", status: "live", description: "PDF semanal" },
  { id: "public_api", name: "API pública", status: "beta", description: "Webhook out score ≥ 9" },
  { id: "zapier", name: "Zapier / Make", status: "live", description: "Notion, HubSpot" },
  ...
  { id: "chrome_ext", name: "Chrome extension", status: "beta", description: "Overlay HN/Reddit" },
  ...
  { id: "tweet_thread", name: "Thread 3 tweets", status: "live", description: "Desde señal HN" },
  { id: "translate", name: "Traducción auto", status: "live", description: "Otros idiomas" },
  ...
  { id: "agency", name: "Plan Agency", status: "beta", description: "10 productos" },
  { id: "white_label", name: "White-label", status: "live", description: "Agencias" },
  ...
  { id: "referral", name: "Referral", status: "live", description: "1 mes Pro por invitar" },
  { id: "ltd", name: "Lifetime deal", status: "beta", description: "AppSumo-style" },
